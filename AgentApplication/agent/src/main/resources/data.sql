...
INSERT INTO admin (`id`, `email`, `first_name`, `last_name`, `password`, `username`, is_activated)
    VALUES (1, "admin@gmail.com", "Admin", "Admirovic", "$2a$10$1P.3BtNc4h5aC7ZTDUhM6OM9/kYw5jkalw0cIDEtWLQqaTGPuMXju", "admin", true);
